...
@Component({
  selector: 'app-labour-chart',
  templateUrl: './labour-chart.component.html',
  styleUrls: ['./labour-chart.component.css']
})
export class LabourChartComponent implements OnInit {

  @ViewChild('labourChart', { static: false }) private chartContainer: ElementRef;
